...
public class SearchForARange {
    ...
    public int[] searchRange(int[] nums, int target) {
        ...
        result[0] = findStartBoundary(nums, target);
        result[1] = findEndBoundary(nums, target);
        return result;
    }

    public int findStartBoundary(int[] nums, int target){
    ...
    public int findEndBoundary(int[] nums, int target){
